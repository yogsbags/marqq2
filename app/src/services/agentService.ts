...
Keep the response concise and business-focused.`;
  ...
  private static async executeAIOutreach(agent: Agent, input: any): Promise<any> {
    ...
    const campaignResults = {
      ...
      messagesSent: Math.floor((leads?.length || 2847) * 0.8),
      channels: channels,
      sendRate: sendRate,
      ...
      responses: [
        {
          ...
          response: 'This looks interesting. Can we schedule a demo next week?',
          sentiment: 'positive',
          nextAction: 'schedule_demo'
        },
        {
          company: 'InnovateLabs Inc',
          contact: 'sarah.johnson@innovatelabs.com',
          response: 'Perfect timing! We\'re evaluating solutions. Let\'s talk Thursday.',
          sentiment: 'very_positive',
          nextAction: 'meeting_scheduled'
        },
        {
          company: 'DataDriven Systems',
          contact: 'mike.chen@datadriven.com',
          response: 'Not right now, but check back in Q2.',
          sentiment: 'neutral',
          nextAction: 'follow_up_q2'
        }
      ],
      insights: [
        'Technology companies show 34% higher response rates',
        'Personalized subject lines improve open rates by 23%',
        'Tuesday and Wednesday are optimal send days',
        'Follow-up messages have 67% higher conversion rates'
      ],
      nextSteps: [
        'Schedule demos with 42 interested prospects',
        'Add 89 leads to nurture sequence',
        'Create retargeting audience from email opens',
