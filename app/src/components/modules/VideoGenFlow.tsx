      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold text-slate-800 dark:text-slate-100">
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600 dark:bg-purple-900/40 dark:text-purple-300">1</span>
              Select Model
            </h2>
          ...
          <section className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold text-slate-800 dark:text-slate-100">
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600 dark:bg-purple-900/40 dark:text-purple-300">2</span>
              Select Strategy
            </h2>
          ...
          {model !== 'omnihuman-1.5' && (
            <section className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="mb-1 block text-xs font-medium text-slate-600 dark:text-slate-300">Resolution</label>
                  <select
                    value={resolution}
                    onChange={(e) => setResolution(e.target.value as any)}
                    className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                  >
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-slate-600 dark:text-slate-300">Duration</label>
                  <select
                    value={duration}
          ...
          <section className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            {model !== 'omnihuman-1.5' && (
              <>
                <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold text-slate-800 dark:text-slate-100">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600 dark:bg-purple-900/40 dark:text-purple-300">3</span>
                  Refine Prompt
                </h2>
                <VideoPromptInput
                  prompt={prompt}
          ...
          <div className="space-y-3 rounded-lg border bg-card text-card-foreground shadow-sm p-6">
        ...
        <div className="lg:sticky lg:top-8 h-fit space-y-4">
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
            <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold text-slate-800 dark:text-slate-100">
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-xs font-semibold text-purple-600 dark:bg-purple-900/40 dark:text-purple-300">4</span>
              Preview
            </h2>
            <VideoDisplay
              videoUrl={videoUrl}
          ...
          {error && (
            <div className="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-red-700 dark:border-red-900/40 dark:bg-red-950/30 dark:text-red-300">
          ...
          <div className="rounded-lg border bg-muted/50 p-4 text-xs font-mono text-muted-foreground">
            <div className="mb-2 font-semibold text-foreground">Current Configuration:</div>
