            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground flex items-center gap-1">Call Outcome: Meeting Scheduled <CheckCircle2 className="inline h-4 w-4 text-green-500 mx-1" /></span>
