    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Generate a scorecard from your exports/notes (no hardcoded metrics).</p>
        </div>
        {connectorsMeta ? (
          ...
          {steps.map((s) => (
            <div
              ...
              className={cn(
                ...
                s.status === 'processing' ? 'border-purple-200 bg-purple-50' : '',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-3">
                ...
                {uploadedFileName ? <div className="text-xs text-gray-600">Loaded: {uploadedFileName}</div> : null}

                <div className="space-y-2">
                  <div className="text-xs text-gray-600">Business context (optional)</div>
                  <Textarea
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-xs text-gray-600">Data (paste export)</div>
                    {dataText.trim() ? (
