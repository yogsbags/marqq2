...
The MKG is a per-company JSON document stored at `platform/agent-runtime/memory/{companyId}/mkg.json`. It contains 12 top-level fields, each with a value and metadata:
